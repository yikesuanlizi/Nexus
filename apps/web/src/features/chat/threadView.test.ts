...
describe('threadView', () => {
  ...
  it('keeps workflow checkpoint items out of the transcript', () => {
    const groups = groupTranscriptItems([
      {
        id: 'workflow-cp-1',
        type: 'workflow_checkpoint',
        turnId: 'workflow-turn',
        text: JSON.stringify({ workflow: { definition: { goal: 'should stay in right pane' } } }),
      },
      { id: 'user-1', type: 'user_message', turnId: 'turn-1', text: '继续' },
    ]);
